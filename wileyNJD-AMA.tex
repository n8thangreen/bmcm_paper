...
The mortality data are adjusted for country, age and gender; thus providing a granular account of the different patient profiles in the trial.
...
% Define the centred global cure fraction on the logit scale $x \sim \mbox{N}(0, \sigma^2)$.
% \begin{eqnarray*}
