...
%%TODO: should we include this plot in the main text?
\begin{figure}[!ht]
\centering
\includegraphics[width=0.7\linewidth]{plot_S_overlay.png}
\caption{\label{fig:S_overlay} Bayesian hierarchical mixture cure model posterior survival curves using complete CheckMate 067 trial data.}
\end{figure}
...
Table~\ref{tab:cutpoint_pred} shows the survival estimates at 60 months extrapolated using 12 and 30 months data cut point.

\begin{table*}[!ht]
\centering
\caption{Survival estimates at 60 months using 12 and 30 months data cut point. \label{tab:cutpoint_pred}}
\begin{tabular}{l|l|l|l|l|l|l}
\hline
End-point & Model & Distribution & Cut point & Ipilimumab & Nivolumab & Combined\\
 & & & (months) & & & \\
\hline
OS & hier & exp & 12 & 0.19 [0.11, 0.34] & 0.33 [0.27, 0.39] & 0.33 [0.2, 0.46]\\
\hline
OS & hier & exp & 30 & 0.2 [0.11, 0.28] & 0.33 [0.28, 0.38] & 0.47 [0.4, 0.55]\\
\hline
OS & hier & lognormal & 12 & 0.32 [0.22, 0.42] & 0.38 [0.33, 0.43] & 0.44 [0.33, 0.53]\\
\hline
...
\hline
PFS & hier & exp & 12 & 0.07 [0.02, 0.13] & 0.36 [0.21, 0.47] & 0.4 [0.33, 0.46]\\
\hline
PFS & hier & exp & 30 & 0.1 [0.07, 0.14] & 0.41 [0.34, 0.49] & 0.39 [0.33, 0.45]\\
\hline
PFS & hier & lognormal & 12 & 0.14 [0.09, 0.19] & 0.45 [0.36, 0.54] & 0.45 [0.39, 0.51]\\
\hline
